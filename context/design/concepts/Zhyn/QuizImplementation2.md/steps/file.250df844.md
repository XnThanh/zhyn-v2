...
content_id: 250df8446483555d806ad12299c55ec67489486954bc287051062576ad88f810
---
...
export default class QuizConcept {
   ...
   * associated character and target ZhuyinRep, other fields unset.
   * @returns questionId
   */
  async register(
    { character, zhuyinRep }: { character: Character; zhuyinRep: ZhuyinRep },
  ): Promise<{ questionId: ID }> {
    // TODO: Check that requires clause holds via sync
